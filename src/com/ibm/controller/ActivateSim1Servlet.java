...
/**
 * Servlet implementation class ActivateSim1Servlet
 */
public class ActivateSim1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActivateSim1Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (disable != null) {
			...
			String query="update sim_details1 set state= 'active' where sim_id in("+disable_key+")  ";
			System.out.println("Servlet"+query);
			
			r=DAOFactory.loginValidateDAO.updatequery(query);
			if(r!=0){
				String msg="Requested Sims are activated successfully";
