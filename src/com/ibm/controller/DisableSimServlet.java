...
/**
 * Servlet implementation class DisableSimServlet
 */
public class DisableSimServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisableSimServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query=null;
		query="select * from sim_details1 where "+sim_type_key+circle_key+Keyword_key +" and status=1  ";
		...
		RequestDispatcher rd=request.getRequestDispatcher("DisableSimResult.jsp");
