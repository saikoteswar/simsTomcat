...
/**
 * Servlet implementation class DisableSim1Servlet
 */
public class DisableSim1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisableSim1Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (disable != null) {
			...
			String query="update sim_details1 set status=0 where sim_id in("+disable_key+")  ";
			System.out.println("Servlet"+query);
			
			r=DAOFactory.loginValidateDAO.updatequery(query);
			if(r!=0){
				String msg="Requested Sims were disabled successfully";
