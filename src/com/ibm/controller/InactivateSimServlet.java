...
/**
 * Servlet implementation class InactivateSimServlet
 */
public class InactivateSimServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InactivateSimServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query=null;
		query="select * from sim_details1 where "+sim_type_key+circle_key+Keyword_key +" and state='active'  ";
		...
		RequestDispatcher rd=request.getRequestDispatcher("InactivateSimResult.jsp");
