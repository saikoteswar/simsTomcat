...
/**
 * Servlet implementation class RequestNewSimServlet
 */
public class RequestNewSimServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RequestNewSimServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query=null;
		query="select * from sim_details1 where "+sim_type_key+circle_key+Keyword_key+" and allocated=0 and state= 'active' order by to_date('added_date','dd-MMM-yy') desc ";
