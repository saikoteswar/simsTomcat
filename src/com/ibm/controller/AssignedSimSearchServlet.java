...
/**
 * Servlet implementation class AssignedSimSearchServlet
 */
public class AssignedSimSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AssignedSimSearchServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		query="select distinct a.sim_id,a.sim_number ,a.sim_type,a.circle,a.mobile_number,a.balance,a.hlrid,a.unbilledamt,a.dueamt,a.added_date,b.request_id, b.emp_name,b.manager_name,b.from_date,b.to_date,b.applied_date,b.return_flag,a.state from sim_details1 a,sim_requests1 b    where a.sim_id=b.sim_id and b.status=5 "+sim_type_key+circle_key+Keyword_key +"  order by to_date(b.to_date,'mm/dd/yyyy')";
