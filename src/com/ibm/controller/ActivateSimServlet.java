...
/**
 * Servlet implementation class ActivateSimServlet
 */
public class ActivateSimServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query=null;
		query="select * from sim_details1 where "+sim_type_key+circle_key+Keyword_key +" and state='inactive'  ";
		...
		RequestDispatcher rd=request.getRequestDispatcher("ActivateSimResult.jsp");
