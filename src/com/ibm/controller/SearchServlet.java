...
public class SearchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stubber
		...
		if (sim_type != null) {
			if (!sim_type[0].equalsIgnoreCase("All")) {
				...
				sim_type_key=" sim_type in (select distinct sim_type from sim_details)";
				//System.out.println(project_name_key);
			}
		} else{
			sim_type_key=" sim_type in (select distinct sim_type from sim_details)";
		...
		String query=null;
		query="select * from sim_details where "+sim_type_key+circle_key+Keyword_key;
