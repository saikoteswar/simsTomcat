...
function IsEmpty(){
  ...
  if (haschecked==false){
  alert("Please select a Sim to Update");
  return false;
    }
...
ArrayList<Sim> list3 = DAOFactory.loginValidateDAO.search_result(query);

%>
<body>

<form action="UpdateSim" method="post" name="resfrm">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<table width="94%" border="0" cellpadding="0" cellspacing="0"
							...
							type="checkbox" name="select_all"  id="select_all" onclick="selectCB()">
								...
								<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="11%">Status</td>	
								<td align="center" background="images/TableBG.jpg"
			...
			Iterator<Sim> it = list3.iterator();
			while(it.hasNext())
			{i++;
				Sim obj= it.next();	
			%>					
								...
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getState()%></td>
				...
				<center><input name="Submit" type="submit" class="Button"
							...
							<br>
				<br>
				<center><%}else{%><h3 class="normaltextbold"> There are no sims to update </h3> <% }%></center>
