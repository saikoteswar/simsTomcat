...
ArrayList<Sim> list = (ArrayList<Sim>)request.getSession().getAttribute("admin_pending_list");


%>
<body>

<form action="AdminAction" method="post" name="resfrm">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<table width="94%" border="0" cellpadding="0" cellspacing="0"
							...
							type="checkbox" name="select_all"  id="select_all" onclick="selectCB()">
								...
								<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="18%">Mobile Number</td>
									<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="18%">Sim Type</td>
									<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="18%">Circle</td>
									<td align="center" background="images/TableBG.jpg"
								...
								<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="13%">Manager's Name</td>	
								<td align="center" background="images/TableBG.jpg"
			...
			%>					
								...
								<td class="normaltext" align="center" height="42" width="131"><%=obj.getType()%></td>
								<td class="normaltext" align="center" height="42" width="120"><%=obj.getCircle()%></td>
								<td class="normaltext" align="center" height="42" width="156"><%=obj.getBalance()%></td>
								<td class="normaltext" align="center" height="42" width="131"><%=obj.getUnbilled_amt()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getDue_amt()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getEmp_name()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getManager_name()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getApplied_date()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getFrom_date()%></td>
								<td class="normaltext" align="center" height="42" width="111"><%=obj.getTo_date()%></td>
