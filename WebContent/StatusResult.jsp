	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<table width="94%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td align="center" background="images/TableBG.jpg"
									class="boldwhitetext" height="42" width="8%">Business Justification</td>	
								<td align="center" background="images/TableBG.jpg"
			...
			%>					
								...
								<td class="normaltext" align="center" height="42" width="45"><%=obj.getBusiness_justification()%></td>
								<%if(obj.getStatus()==1){ %>
				...
				<center><%}else{%><h3 class="normaltextbold"> There are no such Requests raised </h3> <% }%></center>
				<br>
