...
var response=confirm("De-activate the selected user");
if (!response){
return false;}
...
<%
	ArrayList<Login> list1=DAOFactory.loginValidateDAO.deactivate_users(); 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<center><br>
		<br>
		<input class="Button2" type="Submit" value="Deactivate"
			onclick="return display3(); ">
		</form>
		<%}else{ %>
		
		<center class="normaltextbold">Employee not found to De-activate</center>
		<%} %>
		</center>
		<br>
		<br>
